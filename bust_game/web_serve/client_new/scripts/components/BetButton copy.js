           ...
           console.log(canUserBet)
            ...
            if(notPlayingOrBetting) {
                ...
                if(isBetting) {
                    ...
                    console.log(this.state.initialDisable, canUserBet.message)
                	var btnText =   (canUserBet.message == 'Insuffient amount')? (smallButton? 'Bet' : canUserBet.message) : (smallButton? 'Bet' : 'Place bet');
                    ...
                    if(invalidBet) {
                    	...
                    	var btnText =   (canUserBet.message == 'Insuffient amount')? 
                        (smallButton? 'Bet' : canUserBet.message) : 
                        (smallButton? 'Bet' : canUserBet.message);
