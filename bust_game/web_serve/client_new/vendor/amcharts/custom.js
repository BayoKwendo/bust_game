    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "<tr><th>Crash At:</th><td>" + (typeof entry.game_crash !== 'undefined' ? (entry.game_crash).toFixed(2) + 'x' : '?') + "</td></tr>" +
                "<tr><th>Cashed Out:</th><td>" + (entry.cash_out ? (entry.cash_out / entry.bet).toFixed(2) + 'x' : '-') + "</td></tr>" +
                '<tr><th>Bonus: </th><td>' + (entry.bonus ? (entry.bonus).toFixed(2) : 0) + ' bits</td></tr>' +
