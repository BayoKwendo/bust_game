...
define([
    ...
    return {
        ...
        // currentlyPlayStopAt: function (engine) {
        ...
        isBettingTest: function (engine) {
            return engine.nextBetAmount
        },
        ...
        canUserBet: function (balanceSatoshis, betStringBits, betInvalid, autoCashOutInvalid) {
            ...
            if (balanceSatoshis < 10)
                return new Error('Insuffient balance');
            if (betInvalid)
