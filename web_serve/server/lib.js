...
exports.isInvalidPhone = function(msisdn) {
    // if (typeof msisdn !== 'string') return 'NOT_STRING';
    if (msisdn.length > 13) return 'TOO_LONG';
    if (msisdn.length < 10) return 'TOO_SHORT';
    return false;
};
