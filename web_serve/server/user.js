...
exports.confirmDeposit = function (req, res, next) {
    ...
    database.addDeposit(function (err) {
...
exports.checkDeposit = function (req, res, next) {
    // if (req.body.status == 'success') {
    database.getDepositQueue(function (err, data) {
        if (err) res.status(500).json({ success: false, message: 'Sorry, ' + err });
        res.status(200).json({ success: true, message: data });
    });
};

exports.checkDepositQueue = function (req, res, next) {
    // if (req.body.status == 'success') {
    database.addDeposit(function (err) {
        if (err) res.status(500).json({ success: false, message: 'Sorry, ' + err });
        res.status(200).json({ success: true, message: 'Success!' });
